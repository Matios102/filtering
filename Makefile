#############################################################################
# Makefile for building: filtering.app/Contents/MacOS/filtering
# Generated by qmake (3.1) (Qt 6.8.2)
# Project:  filtering.pro
# Template: app
# Command: /opt/homebrew/bin/qmake -o Makefile filtering.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = filtering1.0.0
DISTDIR = /Users/mateuszosik/repos/Uni/Semester6/CG/Task1/filtering/obj/filtering1.0.0
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		filtering.pro include/kernel.h \
...
DESTDIR       = 
TARGET        = filtering.app/Contents/MacOS/filtering

####### Custom Variables
EXPORT_QMAKE_MAC_SDK = macosx
EXPORT_QMAKE_MAC_SDK_VERSION = 15.2
EXPORT_QMAKE_XCODE_DEVELOPER_PATH = /Library/Developer/CommandLineTools
EXPORT__QMAKE_STASH_ = /Users/mateuszosik/repos/Uni/Semester6/CG/Task1/filtering/.qmake.stash
...
EXPORT__PRO_FILE_ = /Users/mateuszosik/repos/Uni/Semester6/CG/Task1/filtering/filtering.pro
...
filtering.app/Contents/MacOS/filtering: obj/ui_mainwindow.h $(OBJECTS)  
	@test -d filtering.app/Contents/MacOS/ || mkdir -p filtering.app/Contents/MacOS/
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: filtering.pro /opt/homebrew/share/qt/mkspecs/macx-clang/qmake.conf /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		/opt/homebrew/share/qt/mkspecs/features/device_config.prf \
		/opt/homebrew/Cellar/qt/6.8.2/share/qt/mkspecs/common/unix.conf \
		/opt/homebrew/Cellar/qt/6.8.2/share/qt/mkspecs/common/mac.conf \
		/opt/homebrew/Cellar/qt/6.8.2/share/qt/mkspecs/common/macx.conf \
	...
	$(QMAKE) -o Makefile filtering.pro
...
filtering.app/Contents/PkgInfo: 
	@test -d filtering.app/Contents || mkdir -p filtering.app/Contents
	@$(DEL_FILE) filtering.app/Contents/PkgInfo
	@echo "APPL????" > filtering.app/Contents/PkgInfo
filtering.app/Contents/Info.plist: 
	@test -d filtering.app/Contents || mkdir -p filtering.app/Contents
	@$(DEL_FILE) filtering.app/Contents/Info.plist
	@plutil -convert xml1 -o - /opt/homebrew/share/qt/mkspecs/macx-clang/Info.plist.app | sed -e "s,@SHORT_VERSION@,1.0,g" -e "s,\$${QMAKE_SHORT_VERSION},1.0,g" -e "s,@FULL_VERSION@,1.0.0,g" -e "s,\$${QMAKE_FULL_VERSION},1.0.0,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" -e "s,@BUNDLEIDENTIFIER@,io.iosapp.filtering,g" -e "s,\$${PRODUCT_BUNDLE_IDENTIFIER},io.iosapp.filtering,g" -e "s,\$${MACOSX_DEPLOYMENT_TARGET},14.0,g" -e "s,\$${IPHONEOS_DEPLOYMENT_TARGET},,g" -e "s,\$${TVOS_DEPLOYMENT_TARGET},,g" -e "s,\$${WATCHOS_DEPLOYMENT_TARGET},,g" -e "s,\$${IOS_LAUNCH_SCREEN},LaunchScreen,g" -e "s,@ICON@,,g" -e "s,\$${ASSETCATALOG_COMPILER_APPICON_NAME},,g" -e "s,@EXECUTABLE@,filtering,g" -e "s,@LIBRARY@,filtering,g" -e "s,\$${EXECUTABLE_NAME},filtering,g" -e "s,@TYPEINFO@,????,g" -e "s,\$${QMAKE_PKGINFO_TYPEINFO},????,g" >filtering.app/Contents/Info.plist

all: Makefile \
		filtering.app/Contents/PkgInfo \
		filtering.app/Contents/Info.plist filtering.app/Contents/MacOS/filtering
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/kernel.h include/imageprocessor.h include/filtereditordialog.h include/mainwindow.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp src/kernel.cpp src/imageprocessor.cpp src/filtereditordialog.cpp src/mainwindow.cpp $(DISTDIR)/
...
obj/ui_mainwindow.h: mainwindow.ui \
	...
	/opt/homebrew/share/qt/libexec/uic mainwindow.ui -o obj/ui_mainwindow.h
...
obj/kernel.o: src/kernel.cpp include/kernel.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QVector \
		/opt/homebrew/lib/QtCore.framework/Headers/qvector.h \
		/opt/homebrew/lib/QtCore.framework/Headers/QString \
		/opt/homebrew/lib/QtCore.framework/Headers/qstring.h \
	...
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o obj/kernel.o src/kernel.cpp
...
install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/filtering/bin || mkdir -p $(INSTALL_ROOT)/opt/filtering/bin
	$(DEL_FILE) -r $(INSTALL_ROOT)/opt/filtering/bin/filtering.app
	
	$(QINSTALL) filtering.app $(INSTALL_ROOT)/opt/filtering/bin/filtering.app
	-$(STRIP) $(INSTALL_ROOT)/opt/filtering/bin/filtering.app/Contents/MacOS/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) -r $(INSTALL_ROOT)/opt/filtering/bin/filtering.app
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/filtering/bin/ 
